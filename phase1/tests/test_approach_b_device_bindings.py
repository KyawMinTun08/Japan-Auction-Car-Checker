...
def test_pwa_cache_version_matches_frontend_app_version():
    assert "APP_VERSION     = '2026.08.20-startup-faststart-native-transport-diagnostics-v11';" in WEB
    assert "params.get('app')==='flutter'" in WEB
    assert "params.set('build','2026.08.20.5')" in WEB
    assert "jacc-2026.08.20-startup-faststart-native-transport-diagnostics-v11" in SW
